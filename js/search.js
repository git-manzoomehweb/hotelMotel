...
$(document).ready(function () {
    $("#backtoback").click(function () {
        $(this).closest("#item-Flight").find(".end_date").addClass("nextCalOpening")
        $("#flight-form #inp2").prop("disabled", false);
        $("#flight-form #inp2").removeClass("Noactive-date");
        $("#flight-form #inp2").closest(".result-for").removeClass("Noactive-date-section");
    ...
    $("#oneway").click(function () {
        $(this).closest("#item-Flight").find(".end_date").removeClass("nextCalOpening")
        $("#flight-form #inp2").prop("disabled", true);
        $("#flight-form #inp2").addClass("Noactive-date");
        $("#flight-form #inp2").closest(".result-for").addClass("Noactive-date-section");
    ...
    $("#Flight").click(function () {
        ...
        $(".search-box-banner").addClass('bg-flight');
        $(".search-box-banner").removeClass('bg-hotel');
        $(".search-box-banner").removeClass('bg-flighthotel');
        $(".search-box-banner").removeClass('bg-insurance');
        $(".faq-container").addClass("unvisible");
        $("#flight_faq").removeClass("unvisible");
    });
    $("#Hotel").click(function () {
        ...
        if( $(this).attr('data-open') == 0){
            setTimeout(function () {
                $(".wating-search.hotel").addClass('unvisible')
                $("#hotel-form").removeClass('unvisible')
                $(this).attr("data-open","1");
            }, 200);
        }
        $(".search-box-banner").removeClass('bg-flight');
        $(".search-box-banner").addClass('bg-hotel');
        $(".search-box-banner").removeClass('bg-flighthotel');
        $(".search-box-banner").removeClass('bg-insurance');
        $(".faq-container").addClass("unvisible");
        $("#hotel_faq").removeClass("unvisible");
    });
    $("#Tour").click(function () {
        $(this).addClass("active-moudle");
        $(this).siblings("li").removeClass("active-moudle");
    ...
    $("#FlightHotel").click(function () {
        ...
        if( $(this).attr('data-open') == 0){
            setTimeout(function () {
                $(".wating-search.flightHotel").addClass('unvisible')
                $("#flightHotel-form").removeClass('unvisible')
                $(this).attr("data-open","1");
            }, 200);
        }
        $(".search-box-banner").removeClass('bg-flight');
        $(".search-box-banner").removeClass('bg-hotel');
        $(".search-box-banner").addClass('bg-flighthotel');
        $(".search-box-banner").removeClass('bg-insurance');
        $(".faq-container").addClass("unvisible");
        $("#tour_faq").removeClass("unvisible");
    });
    $("#Insurance").click(function () {
        ...
        setTimeout(function () {
            $(".wating-search.insurance").addClass('unvisible')
            $("#insurance-form").removeClass('unvisible')
            $(this).attr("data-open","1");
        }, 200);
        $(".search-box-banner").removeClass('bg-flight');
        $(".search-box-banner").removeClass('bg-hotel');
        $(".search-box-banner").removeClass('bg-flighthotel');
        $(".search-box-banner").addClass('bg-insurance');
        $(".faq-container").addClass("unvisible");
        $("#insurance_faq").removeClass("unvisible");
    });
...
function openNextCal(e) {
    let activeBtn = $('.search-box-header ul > .active-moudle').attr('data-id');
    if (activeBtn == 'item-FlightHotel') {
        if ($('.check-hotel-date-container').is(':visible')) {
            if ($('.check-hotel-date-container').find(".checkin").val() != '') {
                let returnDate = $('.check-hotel-date-container').find('.nextCalOpeningex').val();
                if (returnDate == '') {
                    $('.check-hotel-date-container').find('.nextCalOpeningex').trigger("onclick");
                }
            } else {
...
$(document).on('click', function (event) {
    ...
    if (!$(event.target).closest('.show_passengers,#ui-datepicker-div,.FlightClass,.Wrapper-CountPassenger,.plus-minus,.plus-minus-ch,.plus-minus-room,.createChildDropdown select,.add-room,.plus-minus-ins,.BithdatePassenger,.nice-select .option').length) {
...
$(".plus-minus").on("click", function () {
    ...
    var passengers_count = parseInt(button.closest("form").find('.child-count').val()) + parseInt(newVal)
    button.closest("form").find('.count-passengers .count').text(passengers_count)
});
$(".plus-minus-ch").on("click", function () {
    ...
    var passengers_count = parseInt(button.closest("form").find('.adult').val()) + parseInt(newVal)
    button.closest("form").find('.count-passengers .count').text(passengers_count)
    if (oldVal < newVal) {
...
$(".plus-minus-room").on("click", function () {
    ...
    for (i = 1; i <= newVal; i++) {
        button.closest("form").find(".ShowRow").append('<div class="contentRoom"><div class="RoomRow color_2">اتاق ' + i + ' </div><div class="item-CountPassenger"><div class="first-part-CountPassenger">بزرگسال (+12)</div><div class="second-part-CountPassenger"><div class="passenger-button plus-minus"><span class="background-color_1 plus-btn">+</span></div><div class="passenger-button"><input type="text" name="_root.rooms__' + i + '.adultcount" class="adult color_1 width_100 font_15"  readonly="" value="1"></div><div class="passenger-button plus-minus"><span class="minus-btn">-</span></div></div><div class="clr"></div></div><div class="item-CountPassenger"><div class="first-part-CountPassenger">کودک (-12)</div><div class="second-part-CountPassenger"><div class="passenger-button plus-minus-ch"><span class="background-color_1 plus-btn">+</span></div><div class="passenger-button"><input type="text" class="child-count color_1 width_100 font_15"  readonly="" value="0"></div><div class="passenger-button plus-minus-ch"><span class="minus-btn">-</span></div></div><input type="hidden" value="0" class="childcountandage" name="_root.rooms__' + i + '.childcountandage"><div class="clr"></div><div class="section-select-age"></div><div class="clr"></div></div></div>')
    }
...
$("#insurance-form").submit(function (event) {
    $(this).find(".datepicker").each(function () {
        var birthval = $(this).val().length;
        if (birthval < 1) {
            $(this).css("border-color", "red")
            $(this).closest("form").find(".CountPassenger").fadeIn()
            event.preventDefault();
        }
    })
    var passenger_birthday = "";
    $(this).find(".BirthdatePassenger").each(function () {
